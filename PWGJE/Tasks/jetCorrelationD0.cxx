...
struct JetCorrelationD0 
  ...
  PROCESS_SWITCH(JetCorrelationD0, processData, "charged particle level jet analysis", false);
  ...
  PROCESS_SWITCH(JetCorrelationD0, processMCParticle, "process MC Particle jets", true);
